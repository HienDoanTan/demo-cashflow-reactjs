...
export function progressBarRenderer(instance, td, row, column, prop, value, cellProperties) {
...
export function starRenderer(instance, td, row, column, prop, value, cellProperties) {
